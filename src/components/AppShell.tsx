    ...
    <div className="min-h-screen bg-background">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="eyebrow text-xs text-accent">
                {area === 'admin' ? 'Ufficio' : 'Area personale'}
              </p>
      ...
      <footer className="fixed bottom-0 left-0 right-0 z-40 border-t border-border bg-surface/95 backdrop-blur">
        <div className="mx-auto flex max-w-5xl items-center justify-around px-3 py-2">
          <Link
            to="/"
            className="flex flex-col items-center gap-1 px-5 py-1 text-muted-foreground"
          >
          ...
          <Link
            to={isAdmin ? '/admin/altro' : '/u/profilo'}
            className="flex flex-col items-center gap-1 px-5 py-1 text-muted-foreground"
          >
          ...
          {/* MalaMex: voce visibile ma non cliccabile */}
          <div
            className="flex flex-col items-center gap-1 px-5 py-1 text-muted-foreground opacity-60"
            title="Sezione temporaneamente disattivata"
          >
